...
const WarningModal = ({ onClose, name }: WarningModalprops) => {
  ...
  return (
    <FocusTrap open>
      <div className="w-full fixed min-h-screen top-0 left-0 flex items-center justify-center z-50 bg-black/60 backdrop-blur-[2px] transition-all duration-300 ease-in-out px-4">
        <dialog
          open
          aria-modal="true"
